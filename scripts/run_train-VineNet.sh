...
#SBATCH --job-name=cv-Vine-yamaha
#SBATCH --gres=gpu:1
...
log_dir="/nlsasfs/home/nltm-st/sujitk/temp/yashuNet/logs/VineNet/"
output_main="${log_dir}train-CV-10.log"
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python3 -m torch.distributed.launch --nproc_per_node=1 /nlsasfs/home/nltm-st/sujitk/temp/yashuNet/src/train-VineNet-CV10.py &> "$output_main" &
