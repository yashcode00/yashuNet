...
output_main="${log_dir}train-clr.log"
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python3 -m torch.distributed.launch --nproc_per_node=2  --master_port 13335 /nlsasfs/home/nltm-st/sujitk/temp/yashuNet/src/train_cl.py &> "$output_main" &
